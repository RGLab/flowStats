...
G3<-clone(G)
G<-unarchive("tmp.tar")
G<-unarchive(file="~/rglab/workspace/flowStats/data/NormalizationData/GatingSet1")

densityplot(~`<APC-A>` ,getData(G,6))
densityplot(~`<APC Cy7-A>` ,getData(G[-3],5))
plotGate(G2[[1]],1:5,xbin=128)
plotGate(G[-3],9,xbin=128)
plotGate(G[[1]],xbin=128)
@
...
plotGate(G_norm,6,xbin=128)
plotGate(G_norm,9,xbin=128)
@
